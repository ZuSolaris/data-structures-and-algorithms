...
const sortStarWarsCharacters = (starWarsArr) => {
  return starWarsArr.sort((b, a) => a.height - b.height);
};
...
const listFoods = (recipe) => {
  ...
  let ing = ingredients[0].slice(-8);
  result.push(ing);
  let ing2 = ingredients[1].slice(-4);
  result.push(ing2);
  let ing3 = ingredients[2].slice(-11);
  result.push(ing3);
  let ing4 = ingredients[3].slice(-5);
  result.push(ing4);
  let ing5 = ingredients[4].slice(-16);
  result.push(ing5);
  let ing6 = ingredients[5].slice(-12);
  result.push(ing6);
  let ing7 = ingredients[6].slice(-11);
  result.push(ing7);
  let ing8 = ingredients[7].slice(-13);
  result.push(ing8);
  let ing9 = ingredients[8].slice(-8);
  result.push(ing9);
  let ing10 = ingredients[9].slice(-13);
  result.push(ing10);
  let ing11 = ingredients[10].slice(-11);
  result.push(ing11);
