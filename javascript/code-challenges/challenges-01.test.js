...
const addOne = (arr) => {
  ...
  arr.forEach = arr.forEach(element => array.push(element + 1));
...
const addExclamation = (arr) => {
  ...
  arr.forEach = arr.forEach(element => array.push(element + '!'));
...
const allUpperCase = (arr) => {
  ...
  arr.forEach = arr.forEach(element => array.push(element.toUpperCase()));
...
const speaker = (words, callback) => {
  ...
  // Solution code here...
  let array = [];
  words.forEach(eachWord => array.push(callback(eachWord)));
  return array;
};
// speaker(['apple','banana'], greeting());
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
